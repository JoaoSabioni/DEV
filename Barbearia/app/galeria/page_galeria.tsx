    ...
    <div className="bg-black text-white font-sans selection:bg-white selection:text-black min-h-screen overflow-x-hidden">
      ...
      {lightbox && (
        ...
        >
          ...
          <span className="absolute top-7 left-1/2 -translate-x-1/2 text-[10px] tracking-[0.4em] text-zinc-500 uppercase">
          ...
          <div className="relative max-w-[85vw] max-h-[85vh]" onClick={(e) => e.stopPropagation()}>
            <Image src={lightbox.images[lightbox.index]} alt="Foto" width={1200} height={1200}
      ...
      <section className="px-6 md:px-8 py-14 md:py-20 border-b border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-3" style={{ height: 'clamp(260px, 50vw, 540px)' }}>
            <div className="relative overflow-hidden md:flex-[3] h-full">
              <Image src={LOJA[0]} alt="Loja" fill className="object-cover" />
            </div>
            <div className="relative overflow-hidden md:flex-[2] h-full">
              <Image src={LOJA[1]} alt="Loja" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  >
                    ...
                    <div className="absolute bottom-5 right-5 bg-black/70 backdrop-blur-sm px-4 py-2 flex items-center gap-2">
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-zinc-300">
