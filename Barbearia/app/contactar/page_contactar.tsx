          ...
          <div className="flex flex-col justify-start lg:pt-14 gap-8">
            <div className="border-b border-white/5 pb-10">
              ...
              <p className="text-[12px] text-zinc-300 tracking-wider leading-relaxed">
                Seleciona o barbeiro, o serviço pretendido e envia diretamente via WhatsApp.
              </p>
            </div>
            ...
            {!barbeiro && (
              <p className="text-[10px] tracking-[0.2em] text-zinc-500 uppercase italic">
                ← Seleciona um barbeiro para continuar
              </p>
            )}

            <p className="text-[9px] text-zinc-700 tracking-wider leading-relaxed">
              Ao enviar a mensagem, os dados que introduziste são transmitidos diretamente ao barbeiro via WhatsApp. O Elegance Studio não armazena qualquer informação pessoal nos seus servidores.{' '}
