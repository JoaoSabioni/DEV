          ...
          <div className="flex flex-col gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                {BARBEIROS.map((b, i) => (
                  <button key={i} onClick={() => setSelectedBarbeiro(i)} className={`flex items-center gap-5 px-6 py-5 border transition-all duration-300 text-left ${selectedBarbeiro === i ? 'border-white bg-white/5' : 'border-white/10 hover:border-white/30'}`}>
